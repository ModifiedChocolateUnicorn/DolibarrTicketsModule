...
/**
 * \file    modulebuilder/template/core/boxes/ticketsmodulewidget1.php
 * \ingroup ticketsmodule
 * \brief   Widget provided by TicketsModule
 *
 ...
 */
class ticketsmodulewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "ticketsmodulebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "ticketsmodule@ticketsmodule";
	 ...
	 */
	public $depends = array('ticketsmodule');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->ticketsmodule->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/ticketsmodule/class/ticketsmodule.class.php";

		// Populate the head at runtime
		$text = $langs->trans("TicketsModuleBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_ticketsmodule@ticketsmodule',
