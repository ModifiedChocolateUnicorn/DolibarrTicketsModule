...
/**
 * mailing_mailinglist_ticketsmodule
 */
class mailing_mailinglist_ticketsmodule_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_ticketsmodule_myobject';
	...
	var $picto='ticketsmodule@ticketsmodule';
	var $db;
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('ticketsmodule',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/ticketsmodule/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_ticketsmodule_myobject.modules.php: mailing ".$num." targets found");
