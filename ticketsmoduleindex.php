...
/**
 *	\file       htdocs/ticketsmodule/template/ticketsmoduleindex.php
 *	\ingroup    ticketsmodule
 *	\brief      Home page of ticketsmodule top menu
 */
...
$langs->loadLangs(array("ticketsmodule@ticketsmodule"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->ticketsmodule->read) accessforbidden();
...
print load_fiche_titre($langs->trans("TicketsModuleArea"),'','ticketsmodule.png@ticketsmodule');
...
// Draft MyObject
if (! empty($conf->ticketsmodule->enabled) && $user->rights->ticketsmodule->read)
{
	$langs->load("orders");
