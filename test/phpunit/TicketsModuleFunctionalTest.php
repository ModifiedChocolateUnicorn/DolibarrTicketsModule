...
/**
 * \file    test/functional/TicketsModuleFunctionalTest.php
...
/**
 * Class TicketsModuleFunctionalTest
 *
 ...
 *
 * @package Testticketsmodule
 */
class TicketsModuleFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTicketsModule')->click();
		} else {
			// Disable the module
			$this->byHref('modTicketsModule')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/ticketsmodule/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ticketsmodule/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ticketsmodule/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ticketsmodule/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ticketsmodulewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTicketsModule_TicketsModuleTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTicketsModule_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
